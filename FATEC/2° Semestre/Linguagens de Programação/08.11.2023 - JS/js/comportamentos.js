...
function tratar_eventos() {
    ...
    document.getElementById("form-contato").onsubmit = function () {
        ...
        document.getElementById("lista-contatos").getElementsByTagName("tbody")[0].appendChild(tr);
        document.getElementById("formulario-cadastro-contato").style.display = "none"; document.getElementById("mostra-form-cadastro").style.display = "block";
...
function ativar_botoes_exclusao() {
    ...
    var corpo_tabela = document.getElementById("lista-contatos").getElementsByTagName("tbody")[0];
